...
describe('Crisis Detection', () => {
    ...
    it('should boost crisis services', () => {
        const mockServiceC: Service = {
            id: 'crisis-s', name: 'Crisis Line', description: 'Help', url: '', verification_level: VerificationLevel.L2,
            intent_category: IntentCategory.Crisis, provenance: {} as any, identity_tags: [], synthetic_queries: []
        };
        const mockServiceF: Service = {
            id: 'food-s', name: 'Food Bank', description: 'Food', url: '', verification_level: VerificationLevel.L2,
            intent_category: IntentCategory.Food, provenance: {} as any, identity_tags: [], synthetic_queries: []
        };
