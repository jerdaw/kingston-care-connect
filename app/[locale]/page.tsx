    ...
    <main className="relative flex min-h-screen flex-col overflow-hidden">
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32">
        ...
        <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
          <div className="bg-primary-400/40 animate-float dark:bg-primary-900/30 absolute top-[-10%] right-[-10%] h-[50%] w-[50%] rounded-full mix-blend-multiply blur-[100px] dark:mix-blend-screen" />
          <div className="bg-accent-400/40 animate-float-delayed dark:bg-accent-900/30 absolute top-[10%] left-[-10%] h-[50%] w-[50%] rounded-full mix-blend-multiply blur-[100px] dark:mix-blend-screen" />
          <div className="animate-pulse-glow absolute right-[20%] bottom-[-10%] h-[60%] w-[60%] rounded-full bg-indigo-300/40 mix-blend-multiply blur-[100px] dark:bg-indigo-900/30 dark:mix-blend-screen" />
        </div>
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          >
            <div className="shadow-primary-900/5 relative transform overflow-hidden rounded-[2rem] p-[2px] shadow-2xl transition-all duration-500 hover:scale-[1.01]">
              ...
              <div
                className={cn(
                  "relative h-full w-full rounded-[2rem] p-2 transition-all duration-300",
                  isActive
                    ? "border-0 bg-white shadow-none ring-0 outline-none dark:bg-slate-900"
                    : "glass-card border-white/50 bg-white/80 backdrop-blur-xl dark:border-white/5 dark:bg-slate-900/80"
                )}
              >
                <SearchBar
                  query={query}
      ...
      {/* Results Section */}
      <Section className={hasSearched || query.length > 0 ? "pt-0" : "h-0 overflow-hidden py-0 opacity-0"}>
