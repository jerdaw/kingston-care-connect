        ...
        <div className="flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center bg-neutral-50 px-4 text-center dark:bg-neutral-900">
            ...
            <div className="mt-8 w-full max-w-md space-y-4">
                <div className="rounded-lg border border-neutral-200 bg-white p-4 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
                    ...
                    <p className="text-sm text-neutral-500 dark:text-neutral-400 mb-4">You can still call these numbers:</p>
                    ...
                    <ul className="space-y-4">
                        <li className="flex items-center justify-between">
                            ...
                            <a href="tel:6135444229" className="flex items-center gap-2 rounded-md bg-green-50 px-3 py-1.5 text-sm font-medium text-green-700 hover:bg-green-100 dark:bg-green-900/20 dark:text-green-300">
                        ...
                        <li className="flex items-center justify-between">
                            ...
                            <a href="tel:911" className="flex items-center gap-2 rounded-md bg-red-50 px-3 py-1.5 text-sm font-medium text-red-700 hover:bg-red-100 dark:bg-red-900/20 dark:text-red-300">
                                <Phone className="h-4 w-4" />
                                911
                            </a>
                        </li>
