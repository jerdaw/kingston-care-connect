        ...
        if (this.state.hasError) {
            ...
            return (
                <div className="flex min-h-[400px] flex-col items-center justify-center rounded-lg border border-neutral-200 bg-neutral-50 p-8 text-center dark:border-neutral-800 dark:bg-neutral-900">
                    ...
                    {this.state.errorId && (
                        <div className="mb-6 flex items-center gap-2 rounded-md bg-neutral-100 px-3 py-2 text-xs font-mono text-neutral-500 dark:bg-neutral-800 dark:text-neutral-400">
